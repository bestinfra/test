...
const MeterAlert: React.FC = () => {
    ...
    const [activityLogData, _setActivityLogData] =
        useState(dummyActivityLogData);
                                    ...
                                    columns: [
                                        {
                                            ...
                                            props: {
                                                xAxisData:
                                                    dailyTimelineData.days ||
                                                    monthlyTimelineData.months,
                                                seriesColors: [
                                                    "#163b7c",
                                                    "#55b56c",
                                                ], // Force brand colors
                                                seriesData:
                                                    dailyTimelineData.series ||
                                                    monthlyTimelineData.series,
                                                height: 300,
                                                showHeader: true,
                                                headerTitle:
                                                    filterValues.dateRange
                                    ...
                                    columns: [
                                        ...
                                        // },
                                        {
                                            ...
                                            props: {
                                                ...
                                                showHeader: true,
                                                headerTitle:
                                                    "Current Month Tamper Types Distribution",
                                                showDownloadButton: true,
                                                isLoading: isChartLoading,
                                                onClick: (
                                                    segmentName?: string
